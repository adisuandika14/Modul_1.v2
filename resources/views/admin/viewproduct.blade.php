        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="ui-elements.html" class="active-menu"><i class="fa fa-desktop"></i> Product</a>
                    </li>
                    <li>
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Product Tokoan <small>Tempat menemukan barang berharga</small>
                        </h1>
                    </div>
                </div> 
